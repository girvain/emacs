...
(use-package yasnippet
  ...
  :init
    (add-to-list 'load-path
              "~/.emacs.d/.cask/25.3/elpa/yasnippet-20180218.459")
  (require 'yasnippet)
  (yas-global-mode 1))
